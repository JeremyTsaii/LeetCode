<h2>339. Nested List Weight Sum</h2><h3>Easy</h3><hr><div><p>Given a nested list of integers, return the sum of all integers in the list weighted by their depth.</p>
